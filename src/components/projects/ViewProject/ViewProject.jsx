...
let ViewProject = () => {
  return (
    <React.Fragment>
      <section className="view-project-intro p-3">
        <div className="container">
          <div className="row">
            <div className="col">
              <p className="h3 text-warning">View Project</p>
              <p className="fst-italic">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam
                sit quis amet quibusdam soluta! Non reiciendis necessitatibus
                assumenda, laboriosam cum obcaecati numquam facere? Error itaque
                culpa quia cumque ut cum?
              </p>
            </div>
          </div>
        </div>
      </section>
      <section className="view-project mt-3">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8">
              <ul className="list-group">
                ...
                <li className="list-group-item list-group-item-action">
                  ...
                  <span className="">Members List</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <Link to={"/projects/list"} className="btn btn-warning">
                Back
              </Link>
            </div>
          </div>
